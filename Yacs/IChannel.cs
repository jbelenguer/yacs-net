...
namespace Yacs
{
    ...
    public interface IChannel
    {
        ...
        /// <summary>
        /// Sends a message through the channel. This method will throw an <see cref="InvalidOperationException"/> if the channel has no <see cref="BaseOptions.Encoding"/> set.
        /// </summary>
        ...
        /// <summary>
        /// Sends a message through the channel. This method will throw an <see cref="InvalidOperationException"/> if the channel has an <see cref="BaseOptions.Encoding"/> set.
        /// </summary>
        /// <param name="message">The message to send.</param>
        /// <exception cref="InvalidOperationException"></exception>
